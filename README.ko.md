...
크롬 확장은 데스크톱 전용입니다. iOS는 동봉된 Scriptable 스크립트로 iOS 공유 시트를
원탭 "옵시디언에 저장" 흐름으로 만들 수 있습니다(기본 폴더 `mobiletip/`).
...
| 댓글 수집 | 게시글 댓글을 함께 저장 | 꺼짐 |
| 댓글 최대 개수 | 게시글당 최대 N개 | 20 |
| 댓글 범위 | 모두 / 작성자 답글만 | 모두 |
| 댓글 최소 글자 수 | 짧은 잡음 댓글 필터 | 0 |
